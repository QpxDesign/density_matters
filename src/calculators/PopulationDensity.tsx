        ...
        <div style={{ width: "min(30em,90%)", background: "#a5b4fc", margin: "1em auto", }}>
            <div className="h-stack-around">
                ...
                <button style={{ fontSize: "1em", margin: 0, marginRight: ".25em" }} onClick={() => {
                    if (reversed) { setReversed(false) } else {
                        setReversed(true)
                    }
                }}>REVERSE</button>
            </div>
            {reversed ? <><div className="h-stack-around" style={{ background: "#818cf8", width: "100%" }}><h3 style={{ padding: '.65em', gap: '.5em', alignItems: "center" }} className='h-stack'>
                ...
                <div className="h-stack-around" style={{ background: "#818cf8", width: "100%" }}><h3 style={{ padding: '.65em', gap: '.5em', alignItems: "center" }} className='h-stack'>
                    ...
                    <h3 style={{ marginRight: ".75em", fontWeight: 100 }}>{Math.round(((yardSize * 100_000) / GEORGETOWN_POP_DENSITY / DC_SQUARE_MILES) * 100)/100} DCs</h3>
                </div>
                <div className="h-stack-around" style={{ background: "#818cf8", width: "100%" }}><h3 style={{ padding: '.65em', gap: '.5em', alignItems: "center" }} className='h-stack'>
                    <BsBuildingsFill className='icon' />Density of San Francisco⁶</h3>
                    <h3 style={{ marginRight: ".75em", fontWeight: 100 }}>{Math.round(((yardSize * 100_000) / SAN_FRANCISCO_POP_DENSITY / DC_SQUARE_MILES) * 100)/100} DCs</h3>
                </div>
                <div className="h-stack-around" style={{ background: "#818cf8", width: "100%" }}><h3 style={{ padding: '.65em', gap: '.5em', alignItems: "center" }} className='h-stack'>
                    <GiModernCity className='icon' />Density of Manhattan⁶</h3>
                    <h3 style={{ marginRight: ".75em", fontWeight: 100 }}>{Math.round(((yardSize * 100_000) / MIDTOWN_MANHATTAN_POP_DENSITY / DC_SQUARE_MILES)*100)/100} DCs</h3>
                </div> </> : <> <div className="h-stack-around" style={{ background: "#818cf8", width: "100%" }}><h3 style={{ padding: '.65em', gap: '.5em', alignItems: "center" }} className='h-stack'>
                    <BsHouseFill className='icon' />Density of Houston⁶</h3>
