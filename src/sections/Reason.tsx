...
export default function Reason(props: ReasonProps) {
  return (
    <section
      className="reason"
      style={{ background: props.data.background_color,color:props.data.text_color }}
    ...
    >
      ...
      <div className="h-stack">
        <p>{props.data.body}</p>
        <div className="v-stack pw-c" style={{justifyContent:"flex-start",margin:"0 auto"}} >
          <div
          ...
          >
            ...
            if (item === "Slideshow") {
              return <Slideshow data={{imageNames: ["bar1.png","pie.png","bar2.png"], imageAlts: ["","",""]}}/>
            }
            else {
              return <></>
            }
